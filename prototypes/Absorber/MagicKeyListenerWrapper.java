 ...
 *
 * <p>This class adds three pieces of functionality.  First, it delays
 ...
 * also been released.
 *
 * <p>Together, these additions may provide more meaningful semantics
 ...
 */
public class MagicKeyListenerWrapper implements KeyListener {
	 ...
	 */
	public MagicKeyListenerWrapper(KeyListener adaptee) {
		this(adaptee, false);
	}
	 ...
	 */
	public MagicKeyListenerWrapper(KeyListener adaptee, boolean assumeAllReleased) {
		if (adaptee == null)

...
abstract public class AGizmoComponent {
	...
	/**
	 * @return A rectangular object that can be used to check whether a moving Gizmo overlap a Stationary Gizmo, since moving Gizmos such as
	 *         ball can get placed in the middle of grid squares. In a way, this box can be thought of like the concept of "Hitbox" in video
	 *         games. Note that this the bounding box of the actual Gizmo shape. E.g. A Flipper will not return 2L * 2L Rectangle, but
	 *         rather, the size of the actual Flipper graphic.
	 */
	...
	/**
	 * Action that is executed when a Ball has a collision with this component, or from a connection of triggers. Keep in mind there are no
	 * graphical procedures here.
	 * 
	 * @modify this

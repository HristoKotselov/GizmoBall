...
public class PlayModeButtonListener implements ActionListener {
	...
	/**	
	 * The timer handle the implementation need to get a new tick occur in Gizmo Ball periodically. 
	 * Much like MainEngine's moveTime; the lower this value, the smoother the animation will be, 
	 * but also more computationally expensive. Essentially, this can thought of as frames per second. 
	 **/
	private Timer timer;
